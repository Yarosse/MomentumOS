  ...
  return (
    <main className="min-h-screen bg-[#0b1020] px-5 py-8 text-slate-100 sm:px-8">
      <div className="mx-auto max-w-5xl">
        <header className="mb-10 border-b border-slate-700 pb-6"><p className="mb-2 text-xs font-bold tracking-[0.24em] text-cyan-300">MOMENTUM OS · TODAY</p><h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">Одна правильна дія.</h1></header>
